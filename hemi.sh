...
# 메시지를 출력하는 함수 (다양한 색상 적용)
show() {
    case $2 in
        "빨강") COLOR="\033[1;31m" ;; # 빨강
        "초록") COLOR="\033[1;32m" ;; # 초록
        "노랑") COLOR="\033[1;33m" ;; # 노랑
        "파랑") COLOR="\033[1;34m" ;; # 파랑
        "보라") COLOR="\033[1;35m" ;; # 보라
        "하늘") COLOR="\033[1;36m" ;; # 하늘
        *) COLOR="\033[1;37m" ;; # 기본: 흰색
    esac
